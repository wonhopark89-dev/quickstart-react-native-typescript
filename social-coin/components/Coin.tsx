...
const Coin = ({ symbol, index, id }: { symbol: string; index: number; id: string }) => {
  const navigation = useNavigation(); // todo:  해당 타입으로 받을 수 있게 수정해보기
  ...
  return (
    <TouchableOpacity
      style={{ flex: 0.31 }}
      onPress={() => {
        // @ts-ignore // todo:  해당 타입으로 받을 수 있게 수정해보기
