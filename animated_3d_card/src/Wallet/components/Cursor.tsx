...
import {interpolateColors, Circle, Group, useComputedValue, Paint} from '@shopify/react-native-skia';
...
export const Cursor = ({x, y, width}: CursorProps) => {
  ...
  const transform = useComputedValue(() => [{translateX: x.current}, {translateY: y.current}], [x, y]);
  return (
